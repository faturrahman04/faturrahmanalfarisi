      ...
      <div className="px-3 lg:px-20 2xl:px-24 py-6">
        ...
        <div>
          <form ref={form} onSubmit={sendEmail}>
            <input name="name" className="px-3 py-1.5 w-full rounded-md outline-1 outline-gray-300 text-white placeholder:text-gray-400 focus:outline-2 sm:text-sm/6 focus:outline-orange-500 my-8" type="text" placeholder="Full name" />
