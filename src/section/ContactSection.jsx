  ...
  return (
    <section id="contact" className="bg-gray-900">
      <div className="px-3 lg:px-20 2xl:px-24 py-6">
        <h1 className="text-white font-medium font-winkyRough text-xl sm:text-2xl lg:text-5xl">Contact Me</h1>

        <h2 className="text-white/75 font-winkyRough font-light text-sm sm:text-sm lg:text-xl">Thanks for visiting our website, if you want to say something, please input some message into the form below!</h2>
